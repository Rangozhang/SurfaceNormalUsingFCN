...
opt.network = '/home/yu/seg_proj/FCN/Sec_1/checkpoint/fcn_10.net' -- your trained network
opt.list_file = '/home/yu/seg_proj/FCN/3d/list/testLabels.txt'
opt.path_dataset = '/home/yu/seg_proj/FCN/3d/croptest/'
opt.codebooktxt = '/home/yu/seg_proj/FCN/3d/list/codebook_40.txt' 
opt.resultpath =  '/home/yu/seg_proj/FCN/Sec_1/test_res' -- save your results here 
...
model.FCN:add(nn.Exp())
model.FCN:add(nn.ReArrangeBack(16, 16))
...
function getSamples( N, beg)
  ...
  samples = model_FCN:forward(imgs)
